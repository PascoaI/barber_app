...
export function onboardingRouteInfo() {
  return NextResponse.json({
    ok: true,
    route: 'onboarding_requests',
    methods: ['GET', 'POST', 'OPTIONS']
  });
}

export function onboardingRouteOptions() {
...
export async function createOnboardingRequest(req: Request) {
  try {
